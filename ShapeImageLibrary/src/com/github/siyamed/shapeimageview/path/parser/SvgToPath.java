...
@TargetApi(Build.VERSION_CODES.GINGERBREAD) @SuppressLint("NewApi") public class SvgToPath {
    ...
    @TargetApi(Build.VERSION_CODES.GINGERBREAD) private Matrix popTransform() {
